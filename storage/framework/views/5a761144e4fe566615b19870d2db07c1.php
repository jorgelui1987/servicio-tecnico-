        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger" style="font-size:13px;"><?php echo e(session('error')); ?></div>
                <?php endif; ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="cliente_id" id="clienteSelect" class="form-select">
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>"><?php echo e($c->nombre_completo); ?> — <?php echo e($c->telefono); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="selectProd" class="form-select">
                                        ...
                                        <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($p->id); ?>" data-precio="<?php echo e($p->precio_venta); ?>" data-stock="<?php echo e($p->stock); ?>" data-codigo="<?php echo e($p->codigo); ?>" data-codigo_barras="<?php echo e($p->codigo_barras ?? ''); ?>"><?php echo e($p->nombre); ?> (<?php echo e($p->stock); ?>)</option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
