...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-brand d-flex align-items-center gap-3">
        <?php if(isset($empresa) && $empresa && $empresa->logo): ?>
            <img src="<?php echo e(asset($empresa->logo)); ?>" alt="Logo" style="width:42px;height:42px;border-radius:12px;object-fit:contain;">
        <?php else: ?>
            <div class="brand-logo"><i class="fas fa-mobile-alt"></i></div>
        <?php endif; ?>
        <div>
            <div class="brand-name"><?php echo e($empresa->nombre_tienda ?? 'CRM Celulares'); ?></div>
            <div class="brand-sub"><?php echo e($empresa->ruc ? 'RUC: '.$empresa->ruc : 'Panel de gestión'); ?></div>
        </div>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('proveedores.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('proveedores.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('compras.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('compras.*') ? 'active' : ''); ?>">
        ...
        <?php if(Auth::user()->esAdmin()): ?>
        <a href="<?php echo e(route('stock.bajo')); ?>"
           class="nav-link <?php echo e(request()->routeIs('stock.bajo') ? 'active' : ''); ?>">
            ...
            <?php if($stockBajoCount > 0): ?>
                <span class="badge-count"><?php echo e($stockBajoCount); ?></span>
            <?php endif; ?>
        </a>

        <a href="<?php echo e(route('stock.movimientos')); ?>"
           class="nav-link <?php echo e(request()->routeIs('stock.movimientos') || request()->routeIs('stock.ajuste') ? 'active' : ''); ?>">
            <span class="nav-icon"><i class="fas fa-exchange-alt"></i></span>
            Movimientos Stock
        </a>
        <?php endif; ?>

        <?php if(in_array(Auth::user()->rol, ['admin', 'vendedor'])): ?>
        ...
        <?php if(in_array(Auth::user()->rol, ['admin', 'tecnico'])): ?>
        ...
        <a href="<?php echo e(route('financiero.index')); ?>"
           class="nav-link <?php echo e(request()->routeIs('financiero.*') ? 'active' : ''); ?>">
