...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: #1e1b4b;">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">📱 LUITECH </a>
            <div class="ms-auto">
                <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-light me-2">Comenzar Gratis</a>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light">Iniciar Sesión</a>
            </div>
        </div>
    </nav>
    ...
    <header class="hero-section text-white text-center py-5">
        <div class="container">
            ...
            <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-light btn-lg mt-4">Comenzar gratis →</a>
        </div>
    </header>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card pricing-card h-100 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-outline-primary w-100 mt-3">Comenzar Gratis</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card pricing-card h-100 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="price">S/30 <small>/mes</small></div>
                            <ul class="feature-list text-start mt-3">
                            ...
                            <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-outline-primary w-100 mt-3">Lo quiero</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card pricing-card h-100 shadow popular" style="border-color: #0d6efd;">
                        <div class="card-body text-center position-relative">
                            ...
                            <div class="price">S/50 <small>/mes</small></div>
                            <ul class="feature-list text-start mt-3">
                            ...
                            <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-primary w-100 mt-3">Lo quiero</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card pricing-card h-100 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <div class="price">S/100 <small>/mes</small></div>
                            <ul class="feature-list text-start mt-3">
                            ...
                            <a href="<?php echo e(route('registro.tenant')); ?>" class="btn btn-outline-primary w-100 mt-3">Contactar</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-dark text-white text-center py-4">
        <div class="container">
            <p class="mb-0">© <?php echo e(date('Y')); ?> CRM Celulares. Todos los derechos reservados.</p>
            <p class="small text-muted mt-1">
                <a href="#precios" class="text-muted">Planes</a> · 
                <a href="<?php echo e(route('registro.tenant')); ?>" class="text-muted">Registro</a> · 
                <a href="<?php echo e(route('login')); ?>" class="text-muted">Iniciar Sesión</a>
            </p>
        </div>
    </footer>
</body>
</html><?php /**PATH C:\laragon\www\crm-gestion-tienda-celulares\resources\views/landing.blade.php ENDPATH**/ ?>