    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <form action="<?php echo e(route('configuracion.updateEmpresa')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>

                    <!-- Logo actual -->
                    <div class="text-center mb-3">
                        <?php if($empresa && $empresa->logo): ?>
                            <img src="<?php echo e(asset($empresa->logo)); ?>" alt="Logo"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre_tienda" class="form-control"
                               value="<?php echo e(old('nombre_tienda', $empresa->nombre_tienda ?? 'CRM Celulares')); ?>" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">RUC</label>
                        <input type="text" name="ruc" class="form-control"
                               value="<?php echo e(old('ruc', $empresa->ruc ?? '')); ?>" maxlength="20">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Dirección</label>
                        <input type="text" name="direccion" class="form-control"
                               value="<?php echo e(old('direccion', $empresa->direccion ?? '')); ?>" maxlength="500">
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="whatsapp" class="form-control"
                                   value="<?php echo e(old('whatsapp', $empresa->whatsapp ?? '')); ?>"
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="igv" class="form-control" step="0.01" min="0" max="100"
                                   value="<?php echo e(old('igv', $empresa->igv ?? 18)); ?>" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="moneda" class="form-select" required>
                                ...
                                ?>
                                <?php $__currentLoopData = $monedas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cod => $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cod); ?>" <?php echo e((old('moneda', $empresa->moneda ?? 'PEN') == $cod) ? 'selected' : ''); ?>

                                            data-simbolo="<?php echo e($datos['simbolo']); ?>">
                                        <?php echo e($cod); ?> - <?php echo e($datos['pais']); ?> (<?php echo e($datos['simbolo']); ?>)
                                    </option>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="simbolo_moneda" id="simbolo_moneda" class="form-control"
                                   value="<?php echo e(old('simbolo_moneda', $empresa->simbolo_moneda ?? 'S/.')); ?>" required readonly
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="terminos_garantia" class="form-control" rows="2" maxlength="1000"
                                  placeholder="Ej: 30 días de garantía..."><?php echo e(old('terminos_garantia', $empresa->terminos_garantia ?? '')); ?></textarea>
                    </div>
        ...
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <?php
                    ...
                    $planes = ['gratis'=>'🌱 Gratis','basico'=>'🚀 Básico','profesional'=>'⭐ Profesional','empresarial'=>'🏢 Empresarial'];
                    $colores = ['gratis'=>'#6b7280','basico'=>'#06b6d4','profesional'=>'#7c3aed','empresarial'=>'#1e1b4b'];
                    $badgeColor = ['gratis'=>'secondary','basico'=>'info','profesional'=>'primary','empresarial'=>'dark'];
                ?>
                <?php if($tenant): ?>
                    <div class="text-center mb-3">
                        <span class="badge bg-<?php echo e($badgeColor[$tenant->plan] ?? 'secondary'); ?>" style="font-size:1rem; padding:8px 20px;">
                            <?php echo e($planes[$tenant->plan] ?? ucfirst($tenant->plan)); ?>
                    ...
                    <div style="font-size:13px;">
                        <div class="d-flex justify-content-between py-2" style="border-bottom:1px solid #f3f4f6;">
                            ...
                            <span class="badge bg-<?php echo e($tenant->estado === 'activo' ? 'success' : 'danger'); ?>"><?php echo e($tenant->estado); ?></span>
                        </div>
                        <div class="d-flex justify-content-between py-2" style="border-bottom:1px solid #f3f4f6;">
                            <span class="text-muted">Usuarios</span>
                            <span class="fw-500"><?php echo e($usuarios->count()); ?> / <?php echo e($tenant->max_usuarios); ?></span>
                        </div>
                        <div class="d-flex justify-content-between py-2" style="border-bottom:1px solid #f3f4f6;">
                            <span class="text-muted">Productos</span>
                            <span class="fw-500"><?php echo e(\App\Models\Producto::count()); ?> / <?php echo e($tenant->max_productos); ?></span>
                        </div>
                        <div class="d-flex justify-content-between py-2" style="border-bottom:1px solid #f3f4f6;">
                            <span class="text-muted">Vencimiento</span>
                            <span class="fw-500"><?php echo e($tenant->fecha_expiracion ? $tenant->fecha_expiracion->format('d/m/Y') : 'Sin fecha'); ?></span>
                        </div>
                    </div>
                    <div class="mt-3">
                        <a href="<?php echo e(route('planes')); ?>#precios" target="_blank" class="btn btn-outline-primary btn-sm w-100">
            ...
            <div class="card-body p-4">
                ...
                <div style="font-size:13px;" class="mb-3">
                    ...
                    <div class="d-flex justify-content-between py-2">
                        ...
                        <span class="fw-500"><?php echo e($empresa->simbolo_moneda ?? 'S/.'); ?> (<?php echo e($empresa->moneda ?? 'PEN'); ?>)</span>
                    </div>
                </div>
            </div>
        </div>
